...
<body class="bg-[#1c1c38] pb-12">
    ...
    <div id="animatedArea" class="hidden h-screen relative">
        ...
        <nav class="bg-[#101329] w-full sticky top-0 left-0">
            <ul class="container mx-auto py-8 flex items-start gap-10 justify-between">
                ...
                <li class="flex items-center justify-center gap-6">
                    <button class="px-3 text-lg text-[#7367f0] border-b-[#7367f0] border-b-2 py-1">Dashboard</button>
        ...
        <div class="container mx-auto mt-10 grid grid-cols-2 gap-10">

            <!-- user details start-->

            <div onclick="location.href='user-details.php'"
                class="bg-[#101329] cursor-pointer border border-[#a5abb1] text-[#a5abb1] px-5 py-2 hover:scale-105 hover:bg-[#151c44] transition-all duration-500">
                <h3 class="text-lg">User Details</h3>
                <table id="dataTable" class="w-full">
                    <tr>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Id</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[20%]">Name</td>
                        <!-- <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Department</td> -->
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Server</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[20%]">Email</td>
                    </tr>
                    <?php
                        // Fetch data from the database
                        $query = "SELECT * FROM user limit 6";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['user_id'] . "</td>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['username'] . "</td>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['server'] . "</td>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['email'] . "</td>";
                                echo "</tr>";
                            }
                        } else {
                            // No results found
            ...
            <div onclick="location.href='server-list.php'"
                class="bg-[#101329] cursor-pointer border border-[#a5abb1] text-[#a5abb1] px-5 py-2 hover:scale-105 hover:bg-[#151c44] transition-all duration-500">
                <h3 class="text-lg">Server List</h3>
                <table class="w-full">
                    <tr>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Id</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[30%]">Area</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[35%]">Manager</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[35%]">Gmail</td>
                    </tr>
                    <tr>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">1</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">Dhaka</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">Shuvo</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">sroy@gmil.com</td>
                    </tr>
                    <tr>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">2</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">Chittagong</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">Kumar</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">sroy@gmil.com</td>
                    </tr>
                    <tr>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">3</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">Cumilla</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">Roy</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">sroy@gmil.com</td>
                    </tr>
                    <tr>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">4</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">Barishal</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">Roy</td>
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">sroy@gmil.com</td>
                    </tr>
                </table>
            ...
            <div onclick="location.href='department-list.php'"
                class="bg-[#101329] cursor-pointer border border-[#a5abb1] text-[#a5abb1] px-5 py-2 hover:scale-105 hover:bg-[#151c44] transition-all duration-500">
                <h3 class="text-lg">Department List</h3>
                <table class="w-full">
                    <tr>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Id</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[30%]">Department Name</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[30%]">Total Books</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[30%]">Total Users</td>
                    </tr>
                    <?php
                        // Fetch data from the database
                        $query = "SELECT * FROM dept_list limit 6";
                        $result = mysqli_query($connect, $query);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['dept_id'] . "</td>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['dept_name'] . "</td>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['total_books'] . "</td>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['total_users'] . "</td>";
                                echo "</tr>";
                            }
                        } else {
                            // No results found
            ...
            <div onclick="location.href='book-list.php'"
                ...
                <table class="w-full">
                    <tr>
                        ...
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[30%]">Department Name</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[30%]">Writer Name</td>
                    </tr>
                    <?php
                        // Fetch data from the database
