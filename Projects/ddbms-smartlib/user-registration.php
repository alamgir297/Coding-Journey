    ...
    <div id="animatedArea" class="hidden">
        <div class="h-screen flex flex-col py-[50px] gap-[50px] container mx-auto">
            ...
            <div
                ...
                <h3 class="text-center text-2xl border-t-2 border-b-2 border-gray-400 py-4">User Registration</h3>
                ...
                <div >
                    ...
                    pt-4 pb-4 text-xl ps-14 duration-[1000s] w-full border-white text-white !outline-none">
                        ...
                        <input type="date" name="date" id="birth-date" class="bg-transparent w-[60%]">
                    </div>
                ...
                <div class="text-white block text-center pt-4">Have an account?
                    <a href="user-login.php" class="font-bold text-lg transition duration-[0.4s] text-white hover:bg-gradient-to-r hover:from-purple-800 hover:to-indigo-600 hover:text-transparent bg-clip-text">Log In</a>
                </div>
