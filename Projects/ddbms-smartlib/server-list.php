            ...
            <ul class="container mx-auto py-8 flex items-start gap-10 justify-between">
                ...
                <li class="flex items-center justify-center gap-6">
                    ...
                    <button onclick="location.href='server-list.php'"
                        class="px-3 text-lg text-[#7367f0] border-b-[#7367f0] border-b-2 py-1">Server List</button>
            ...
            <div onclick="location.href='server-list.php'"
                ...
                <table class="w-full">
                    <tr>
                        ...
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[20%]">Area</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[20%]">Manager</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[20%]">G mail</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Total Departments</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Total Books</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Total Users</td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-[#a5abb1] px-2 py-1 text-center">50</td>
