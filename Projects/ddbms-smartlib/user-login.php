    ...
    <div id="animatedArea" class="hidden">
        <div class=" h-screen flex flex-col py-[50px] gap-[50px] container mx-auto">
            ...
            <div
                ...
                <h3 class="text-center text-2xl border-t-2 border-b-2 border-gray-400 py-4">User Authentication</h3>

                <!-- login  -->
                <form action="user-login.php" class="w-full" method="post">
                ...
                <!-- <form class="login-form pt-10 flex flex-col items-center justify-center gap-5">
                    <input class="px-5 py-2 bg-transparent border border-gray-400 rounded-md w-[70%]" type="text"
                        placeholder="username" id="username" required />
                    <input class="px-5 py-2 bg-transparent border border-gray-400 rounded-md w-[70%]" type="password"
                    ...
                    <div class="flex items-center justify-center gap-2">
                        <button type="button" id="submit_data"
                            ...
                            Login </button>
                        <button id="back_button" onclick="location.href='index.php'"
                            class="bg-[#101329] border hover:scale-105 hover:bg-[#151c44] transition-all duration-500 rounded-lg px-5 py-2 text-[#a5abb1] font-bold">Back</button>
                    </div>
                </form> -->
                <button onclick="location.href='user-registration.php'"
                    class="text-center text-sm w-full py-1 mt-8">Not registered? <span
                        class="text-green-400 pl-1">Create Account...</span></button>
            </div>
