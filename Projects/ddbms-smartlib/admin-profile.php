...
<body class="bg-[#1c1c38] pb-12">
    ...
    <div id="animatedArea" class="hidden h-screen relative">
        ...
        <div class="container mx-auto mt-[50px] flex items-center justify-center">

            <div class="bg-[#101329] flex items-start justify-start gap-5 px-10 py-10">
                ...
                <div class="text-area space-y-2 divide-y-2 divide-[#a5abb1]">
                    ...
                    <div class="designation text-[#a5abb1] text-2xl flex items-center justify-start gap-5 px-2 py-2">
                        <div class="w-[150px]">
                            Designation:
                        </div>
                        <div>
