...
<body class="bg-[#1c1c38] pb-12">
    ...
    <div id="animatedArea" class="hidden h-screen relative">
            ...
            <ul class="container mx-auto py-8 flex items-start gap-10 justify-between">
                ...
                <li class="flex items-center justify-center gap-6">
                    <button onclick="location.href='dashboard.php'"
                        class="px-3 text-lg text-[#a5abb1] hover:text-[#7367f0] border-b-transparent transition-all duration-500 hover:border-b-[#7367f0] border-b-2 py-1">Dashboard</button>
                    ...
                    <button onclick="location.href='user-details.php'"
                        class="px-3 text-lg text-[#7367f0] border-b-[#7367f0] border-b-2 py-1">User Details</button>
                    ...
                    <button onclick="location.href='book-list.php'"
                        class="px-3 text-lg text-[#a5abb1] hover:text-[#7367f0] border-b-transparent transition-all duration-500 hover:border-b-[#7367f0] border-b-2 py-1">Book
                        List
                    </button>
        ...
        <div class="container mx-auto mt-10">
            ...
            <div class="bg-[#101329] border border-[#a5abb1] text-[#a5abb1] px-5 py-2">
                ...
                <table id="dataTable" class="w-full">
                    <tr>
                        ...
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[20%]">Birthday</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Server</td>
                        <td class="border border-[#a5abb1] text-center px-2 py-1 w-[10%]">Collected Books</td>
                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['birthdate'] . "</td>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['server'] . "</td>";
                                echo "<td class='border border-[#a5abb1] text-center px-2 py-1'>" . $row['collected_books'] . "</td>";
