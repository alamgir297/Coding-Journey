...
<body class="bg-[#1c1c38]">
    ...
    <div id="animatedArea" class="hidden relative h-screen overflow-auto">
        ...
        <div
            class="collected-books-popup transition-all duration-500 opacity-0 -z-10 w-[90%] -translate-x-[50%] -translate-y-[50%] absolute top-[50%] left-[50%] h-[90%] overflow-auto backdrop-blur-xl bg-black/70">
        ...
        <!-- add/delete-books-area popup end -->

        <div
            class="add-delete-popup transition-all duration-500 opacity-0 -z-10 w-[90%] -translate-x-[50%] -translate-y-[50%] absolute top-[50%] left-[50%] h-[90%] overflow-auto backdrop-blur-xl bg-black/70">

            <div class="relative">
                <button class="add-delete-cross-button px-2 py-2 group absolute top-0 right-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 8 8" fill="none">
                        <path
                            d="M0.646447 0.646447C0.841709 0.451184 1.15829 0.451184 1.35355 0.646447L4 3.29289L6.64645 0.646447C6.84171 0.451184 7.15829 0.451184 7.35355 0.646447C7.54882 0.841709 7.54882 1.15829 7.35355 1.35355L4.70711 4L7.35355 6.64645C7.54882 6.84171 7.54882 7.15829 7.35355 7.35355C7.15829 7.54882 6.84171 7.54882 6.64645 7.35355L4 4.70711L1.35355 7.35355C1.15829 7.54882 0.841709 7.54882 0.646447 7.35355C0.451184 7.15829 0.451184 6.84171 0.646447 6.64645L3.29289 4L0.646447 1.35355C0.451184 1.15829 0.451184 0.841709 0.646447 0.646447Z"
                            fill="red" class="group-hover:scale-110 transition-all duration-[0.4s]" />
                ...
                <div class="text-center text-4xl pt-10 text-[#a5abb1]">Add Delete Books</div>
                <div class="w-full my-20 container mx-auto">
                    <!-- Add/Delete Book  -->
                    <form class="add-delte-book-form flex flex-col items-center justify-center gap-5">
                        <input class="px-5 py-2 bg-transparent border text-[#a5abb1] border-gray-400 rounded-md w-[70%]"
                            type="text" placeholder="Book Id" id="book-id" required />

                        <input class="px-5 py-2 bg-transparent border text-[#a5abb1] border-gray-400 rounded-md w-[70%]"
                            type="text" placeholder="Book Name" id="book-name" required />

                        <input class="px-5 py-2 bg-transparent border text-[#a5abb1] border-gray-400 rounded-md w-[70%]"
                            type="text" placeholder="Department Name" id="department-name" required />

                        <input class="px-5 py-2 bg-transparent border text-[#a5abb1] border-gray-400 rounded-md w-[70%]"
                            type="text" placeholder="Total" id="total" required />

                        <input class="px-5 py-2 bg-transparent border text-[#a5abb1] border-gray-400 rounded-md w-[70%]"
                            type="text" placeholder="Collected Date" id="collected-date" required />

                        <input class="px-5 py-2 bg-transparent border text-[#a5abb1] border-gray-400 rounded-md w-[70%]"
                            type="text" placeholder="Return Date" id="return-date" required />

                        <div class="flex items-center justify-center gap-2">
                            <button type="button" id="submit_data"
                                class="bg-[#101329] border hover:scale-105 hover:bg-[#151c44] transition-all duration-500 rounded-lg px-5 py-2 text-[#a5abb1] font-bold">
                                Add Book
                            </button>
                            <button type="button"
                                class="bg-[#101329] border hover:scale-105 hover:bg-[#151c44] transition-all duration-500 rounded-lg px-5 py-2 text-[#a5abb1] font-bold">
        ...
        <div class="container mx-auto flex items-center justify-center">
            ...
            <div class="bg-[#101329] my-16 flex items-start justify-start gap-5 px-10 py-16 relative">
                ...
                <!-- add-delete-area button start     -->
                <button
                    class="add-delete-button absolute top-0 left-0 bg-[#101329] border hover:scale-105 hover:bg-[#151c44] transition-all duration-500 rounded-lg px-5 py-2 text-[#a5abb1] font-bold">
                    Add/Delete Books
                </button>
                <!-- add-delete-area button end     -->
